...
## Domain
Universal knowledge base — all topics welcome. From tech and science to personal notes, projects, and random rabbit holes.

## Conventions
- File names: lowercase, hyphens, no spaces (e.g., `machine-learning.md`)
