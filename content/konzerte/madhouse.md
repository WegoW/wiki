...
|---|-------|-----|-------|------|
| 1 | **4. Juni 1987** | Stuttgart | Hanns-Martin-Schleyer-Halle | Sign o' the Times Tour (Support für Prince) |

## Anmerkungen
- **Support / Teil der Show von Prince** in der Schleyerhalle Stuttgart — Sign o' the Times Tour
- Ticket-Vermerk: *"introducing madhouse"* — Madhouse eröffnete die Show oder trat als Teil des Programms auf
- Kein separates Ticket vorhanden

## Quellen
- Original-Ticket Prince (Sammlung Walter Wego)
- [[konzerte/prince|Prince]] — gemeinsames Konzert (Headliner)

## Verwandte Einträge
- [[queries/concert-collection|Konzertsammlung]]
- [[konzerte/prince|Prince]] — Side-Project / Support Act
